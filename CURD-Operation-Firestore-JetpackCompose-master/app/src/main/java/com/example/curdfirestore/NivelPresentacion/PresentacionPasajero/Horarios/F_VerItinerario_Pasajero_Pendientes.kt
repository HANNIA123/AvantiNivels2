    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                TituloPantalla(Titulo = "Solicitudes \n pendientes", navController,)
                            ...
                            sortedViajes.forEach { day ->
                                ...
                                viajes.filter { it.horario_dia == day }.forEach { viaje ->
                                    ...
                                    if (viaje.horario_solicitud == "Si") { //solo  si tiene solicitjud
                                        ...
                                        /*println("SOLICITUDES")
                                        println(solicitudes)
                                        println("horario solicitud")
                                        println("${viaje.horario_solicitud}")*/


                                        if (terminar) {

                                        println("Terminoooooooooooooo")
                                        if (viaje.horario_solicitud == "Si" && solicitudes == null) {
                                            show = true
                                            VentanaSolicitudesPendientes(
                                                navController,
                                                userId,
                                                show,
                                                { show = false },
