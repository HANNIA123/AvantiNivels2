...
import com.example.curdfirestore.NivelPresentacion.PresentacionConductor.Viajes.VentanaHora
...
fun RegistrarViajePas(
    ...
    var horarioParada by remember { mutableStateOf("Establecer horario") }
...
/*Seleccionar horario de partida*/
                ...
                if (show == true) {
                    VentanaHora(
                        ...
                        onConfirm = {
                                selectedTime ->
                            horarioParada = selectedTime
                            // Haz algo con la hora seleccionada
                            // Por ejemplo, actualiza un ViewModel o realiza alguna otra acción
          ...
          //Notones de guardar y cancelar
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        var HoraCon=horarioParada
                        //horaO="$horaO:$minutoO"

                        if (tipoTrayecto==0){ //UPIITA COMO ORIGEN
                            navController.navigate(route = "registrar_destino_pasajero/$correo/$dia/$HoraCon")

                        }
                        else{ //UPIITA COMO DESTINO
                            navController.navigate(route = "registrar_origen_pasajero/$correo/$dia/$HoraCon")
